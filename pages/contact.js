...
export default function contact() {
  const infoStyles = "text-center flex flex-col pb-6 text-xl max-w-max mx-auto"

  return (
    <>
      <Head>
        <title>Contact | Marin Brothers Inc.</title>
        <meta
          name="description"
      ...
      <main className="sm:px-4">
        <h1>Contact Us!</h1>
        <section className="font-sans max-w-2xl text-xl text-white bg-brown mx-auto py-8 px-5 mb-12">
